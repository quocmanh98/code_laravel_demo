                ...
                <div class="section-detail clearfix">
                    <div class="thumb-wp fl-left">
                        <a href="" title="" id="main-thumb">
                            <img id="zoom" style='max-width:300px' src="{{url('/')}}/{{$product->product_image}}"/> <br>
                        </a>
                        {{-- <div id="list-thumb">
                    ...
                    <div class="info fl-right">
                        ...
                        <div class="num-product">
                            <span class="title">Số Lượng: {!!$product->product_count!!}</span> <br>
                            <span class="status">{!!$product->product_display!!}</span>
                        </div>
                        <p class="price"> <span class="new">{{number_format($product->product_price_new,'0','','.')}} đ</span></p>
                        <div id="num-order-wp">
                            <a title="" id="minus"><i class="fa fa-minus"></i></a>
                            <input type="number" name="num-order" value="1" id="num-order">
                            <a title="" id="plus"><i class="fa fa-plus"></i></a>
                        </div>
                        <a href="{{route('cart.add',$product->product_id)}}" title="Thêm giỏ hàng" class="add-cart">Thêm giỏ hàng</a>
                    </div>
                </div>
            </div>
                    ...
                    <ul class="list-item">
                        <li>
                            <a href="" title="" class="thumb">
                                <img src="{{url('/')}}/public/user/images/img-pro-17.png">
                            </a>
